...
public class PlannedPlacesListAdapter extends RecyclerView.Adapter<PlannedPlacesListAdapter.MyClass> {
    Context context;
    ...
    public PlannedPlacesListAdapter(Context context, ArrayList<Result> placesList, OnPlacesClickListener onPlacesClickListener) {
    ...
    public MyClass onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        View v = LayoutInflater.from(context).inflate(R.layout.places_planned_item, viewGroup, false);
